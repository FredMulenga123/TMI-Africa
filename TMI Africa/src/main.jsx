    ...
    <main className="min-h-screen bg-[#050816] text-white overflow-hidden">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-xl border-b border-white/10 bg-black/30">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-6 flex justify-between items-center">
          ...
          <nav className="hidden md:flex gap-8 text-sm font-semibold text-slate-300">
            ...
            <a href="#requests" className="hover:text-cyan-400 transition">
              Requests
            </a>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 pt-20 pb-20">
        ...
        <div className="rounded-2xl border border-rose-500/20 bg-rose-500/10 px-6 py-4 text-sm text-rose-200 font-semibold">
          ...
          <span className="ml-3 text-white/90">
            Strategic minerals monitoring and sovereign mining risk analytics remain active across Africa.
          </span>
        </div>
        ...
        <div className="mt-12">
          ...
          <h2 className="mt-6 text-6xl lg:text-8xl font-black leading-none max-w-6xl">
            Executive Intelligence Access Platform
          </h2>

          <p className="mt-8 text-slate-300 text-lg max-w-4xl leading-relaxed">
            TerraNova Mining Intelligence provides sovereign mining intelligence,
            strategic mineral analytics, investor due diligence, corridor intelligence
            and mining governance monitoring across Africa.
          </p>
      ...
      >
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <div className="rounded-3xl border border-cyan-500/20 bg-cyan-500/5 backdrop-blur-xl p-10">
            ...
            <h3 className="text-5xl font-black mt-5">
              Executive Intelligence Requests
            </h3>

            <p className="mt-6 text-slate-300 leading-relaxed">
              Request strategic mineral intelligence, sovereign mining risk analysis,
              due diligence reports, corridor intelligence, distressed asset reviews
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-10">
            ...
            <div className="mt-10 space-y-5">
              ...
              <input
                ...
                className="w-full rounded-2xl bg-black/30 border border-white/10 px-5 py-4 outline-none"
              />
              ...
              <select className="w-full rounded-2xl bg-black/30 border border-white/10 px-5 py-4 outline-none">
              ...
              <textarea
                rows="5"
                placeholder="Describe your intelligence request..."
                className="w-full rounded-2xl bg-black/30 border border-white/10 px-5 py-4 outline-none"
              />

              <button className="w-full rounded-2xl bg-cyan-400 text-black font-black py-4 hover:scale-[1.01] transition">
      ...
      >
        ...
        <div className="mb-10">
          ...
          <p className="text-cyan-400 uppercase tracking-[0.4em] text-xs font-bold">
            Sovereign Intelligence Monitor
          </p>

          <h3 className="text-5xl font-black mt-4">
            Africa Strategic Minerals Watchlist
          </h3>
