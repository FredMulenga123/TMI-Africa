    ...
    <main className="min-h-screen bg-[#050816] text-white">
      ...
      >
        ...
        <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-[32px] p-12">
          ...
          <p className="text-slate-200 text-xl max-w-4xl mb-10">
            Request sovereign mining intelligence reports, investor due diligence and strategic corridor intelligence.
          </p>
